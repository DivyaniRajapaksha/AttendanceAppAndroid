...
public class ListAdpter extends BaseAdapter {
    ...
    public View getView(int position, View child, ViewGroup parent) {
        ...
        if (child == null) {
            ...
            holder.stTime_TextView = (TextView) child.findViewById(R.id.textViewSTime);
            holder.eTime_TextView = (TextView) child.findViewById(R.id.textViewETime);
        ...
        holder.stTime_TextView.setText(STime.get(position));
        holder.eTime_TextView.setText(ETime.get(position));
    ...
    public class Holder {
        ...
        TextView stTime_TextView;
        TextView eTime_TextView;
    }
